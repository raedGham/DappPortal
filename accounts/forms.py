...
class EmployeeAccountForm(forms.ModelForm):
  ...
  is_engineer     = forms.BooleanField(required=False,   widget = forms.CheckboxInput(attrs={'class': 'form-check-input'}))
  is_deputy       = forms.BooleanField(required=False,   widget = forms.CheckboxInput(attrs={'class': 'form-check-input'}))
  is_guard        = forms.BooleanField(required=False,   widget = forms.CheckboxInput(attrs={'class': 'form-check-input'}))
  is_AdminNoHead  = forms.BooleanField(required=False,   widget = forms.CheckboxInput(attrs={'class': 'form-check-input'}))
  is_OMwithHead   = forms.BooleanField(required=False,   widget = forms.CheckboxInput(attrs={'class': 'form-check-input'}))
  is_OMnoHead     = forms.BooleanField(required=False,   widget = forms.CheckboxInput(attrs={'class': 'form-check-input'}))
  ...
  class Meta:
    ...
    fields = ['email','first_name','middle_name', 'last_name','password', 'confirm_password','ps_number',
              ...
              'is_head','is_engineer','is_deputy','is_guard','is_AdminNoHead','is_OMwithHead','is_OMwithHead']
  ...
  def __init__(self,*args, **kwargs):
    ...
    for field in self.fields:
        if field not in ["is_head", "is_engineer","is_deputy","is_AdminNoHead","is_OMwithHead","is_OMnoHead",'is_guard']:
